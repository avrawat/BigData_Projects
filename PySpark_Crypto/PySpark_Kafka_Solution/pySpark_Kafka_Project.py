...
def main():
	...
	for symbol in symbols:
		sma.calculateAveragePrice(windowStream,symbol)


	# 2 Max Profit ##########################################################
	maxProfitStock = MaxProfit()
	maxProfitStock.calculateMaxProfit(windowStream)
	
	# 3 Max stock volume ####################################################
	maxVolume = MaxVolumeStock()
	maxVolume.calculateMaxVolume(pairedStream,windowSize,slidingInterval)
